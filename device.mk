...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/android.hardware.camera.provider@2.4-service.rc:system/product/vendor_overlay/$(PRODUCT_TARGET_VNDK_VERSION)/etc/init/android.hardware.camera.provider@2.4-service.rc \
